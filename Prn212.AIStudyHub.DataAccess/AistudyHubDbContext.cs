...
public partial class AistudyHubDbContext : DbContext
{
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    modelBuilder.Entity<AppUser>(entity =>
    {
      ...
      entity.Property(e => e.Role).HasMaxLength(50).IsUnicode(false).HasDefaultValue("Student");
    });
    ...
    modelBuilder.Entity<Document>(entity =>
    {
      ...
      entity.Property(e => e.ContentType).HasMaxLength(100).IsUnicode(false);
      entity.Property(e => e.FileExtension).HasMaxLength(10).IsUnicode(false);
      ...
      entity.HasOne(d => d.User).WithMany(p => p.Documents)
          .HasForeignKey(d => d.UserId).HasConstraintName("FK_Document_User");
    });
